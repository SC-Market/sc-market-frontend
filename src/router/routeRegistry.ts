...
export const routeRegistry: Record<string, RouteImportFunction> = {
  ...
  "/contracts/create": () => import("../pages/contracting/CreatePublicContractPage"),
  ...
  "/contracts/public/:contract_id": () => import("../pages/contracting/ViewPublicContract"),
  "/order/service/:service_id": () => import("../pages/contracting/CreateOrder"),
  ...
  // Recruiting routes
  "/recruiting/post/:post_id": () => import("../pages/recruiting/RecruitingPostPage"),
  ...
  "/market/stock/:listingId": () => import("../pages/market/ManageListingStock"),
  "/market/cart": () => import("../pages/market/MarketCart"),
  "/market_edit/:id": () => import("../pages/market/ViewMarketListing"),
  "/market/multiple/:id/edit": () => import("../pages/market/ViewMarketListing"),
  ...
  "/order/service/:service_id/edit": () => import("../pages/contracting/CreateService"),
  ...
  "/recruiting/post/create": () => import("../pages/recruiting/CreateRecruitingPostPage"),
  "/recruiting/post/:post_id/update": () => import("../pages/recruiting/CreateRecruitingPostPage"),
  ...
  "/contractor_invite/:invite_id": () => import("../pages/contracting/AcceptOrgInvite"),
  ...
  "/admin/notification-test": () => import("../pages/admin/AdminNotificationTest"),
  "/admin/attribute-definitions": () => import("../pages/admin/AdminAttributeDefinitions"),
  "/admin/game-item-attributes": () => import("../pages/admin/AdminGameItemAttributes"),
  "/admin/import-monitoring": () => import("../pages/admin/AdminImportMonitoring"),
