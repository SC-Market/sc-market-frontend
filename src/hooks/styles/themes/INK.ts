...
export const inkThemeOptions: ThemeOptions = {
  palette: {
    ...
    background: { default: "#F0F0F0", paper: "#FFFFFF", sidebar: "#E8E8E8", navbar: "#FFFFFF", light: "#FFFFFF", overlay: "rgba(26,26,26,0.1)", overlayDark: "rgba(26,26,26,0.2)", imageOverlay: "rgba(26,26,26,0.4)", imageOverlayHover: "rgba(26,26,26,0.6)" },
