    ...
    <Container maxWidth="xxl" sx={{ py: 3 }}>
      ...
      <Grid container spacing={4}>
          ...
          <Grid container spacing={2}>
            {[...Array(6)].map((_, i) => (
              <Grid item xs={12} sm={6} md={4} key={i}>
                <Box sx={{ border: 1, borderColor: "divider", borderRadius: 1, p: 2, height: 200 }}>
                  <BaseSkeleton variant="rectangular" width="100%" height={100} sx={{ mb: 1, borderRadius: 1 }} />
        ...
        <Grid item xs={12} xl={7}>
          ...
          {[...Array(3)].map((_, i) => (
            <Box key={i} sx={{ border: 1, borderColor: "divider", borderRadius: 1, p: 2, mb: 2, height: 120 }}>
