      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Box sx={{ display: "flex", gap: 1, mt: 1 }}>
            {[...Array(4)].map((_, i) => (
              <BaseSkeleton key={i} variant="rectangular" width={80} height={80} sx={{ borderRadius: 1 }} />
            ))}
          </Box>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <Box sx={{ display: "flex", gap: 2, mt: 2 }}>
              <BaseSkeleton variant="rectangular" width="60%" height={48} sx={{ borderRadius: 1 }} />
              <BaseSkeleton variant="rectangular" width="38%" height={48} sx={{ borderRadius: 1 }} />
            </Box>
