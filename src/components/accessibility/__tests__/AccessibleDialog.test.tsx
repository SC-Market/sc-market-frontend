...
describe("AccessibleDialog", () => {
  it("renders with title and content", () => {
    render(
      <TestWrapper>
        <AccessibleDialog open={true} onClose={() => {}} title="Test Dialog">
  ...
  it("calls onClose when Escape key is pressed", async () => {
    ...
    render(
      <TestWrapper>
        <AccessibleDialog open={true} onClose={onClose} title="Test Dialog">
          <div>Dialog content</div>
        </AccessibleDialog>
      </TestWrapper>,
    )
  ...
  it("does not render when open is false", () => {
    render(
      <TestWrapper>
        <AccessibleDialog open={false} onClose={() => {}} title="Test Dialog">
          <div>Dialog content</div>
        </AccessibleDialog>
      </TestWrapper>,
    )
